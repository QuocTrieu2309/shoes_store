            ...
            <div class="owl-carousel owl-theme nav-image-center" data-owl-options="{
                ...
                {{-- <div class="product-default left-details">
                    ...
                    <div class="product-details">
                        ...
                        <h3 class="product-title"> <a href="demo9-product.html">Women Winter Shoes</a> </h3>
                        <div class="ratings-container">
                            <div class="product-ratings">
                                <span class="ratings" style="width:0%"></span>
                                <!-- End .ratings -->
                ...
                <div class="product-default left-details">
                    <figure>
                        <a href="demo9-product.html">
                            <img src="porto_ecommerce/assets/images/demoes/demo9/products/product-3.jpg" alt="product" width="300" height="300">
                        </a>
                        <div class="label-group">
                            <span class="product-label label-hot">HOT</span>
                        </div>
                    ...
                    <div class="product-details">
                        ...
                        <h3 class="product-title"> <a href="demo9-product.html">Women Black Bag</a> </h3>
                        <div class="ratings-container">
                            <div class="product-ratings">
                                <span class="ratings" style="width:0%"></span>
                                <!-- End .ratings -->
                        ...
                        <!-- End .price-box -->
                        <div class="product-action">
                            <a href="demo9-product.html" class="btn-icon btn-add-cart"><i
                                    class="fa fa-arrow-right"></i><span>SELECT
                                    OPTIONS</span></a>
                            <a href="wishlist.html" class="btn-icon-wish" title="wishlist"><i
                                    class="icon-heart"></i></a>
                ...
                <div class="product-default left-details">
                    <figure>
                        <a href="demo9-product.html">
                            <img src="porto_ecommerce/assets/images/demoes/demo9/products/product-10.jpg" alt="product" width="300" height="300">
                            <img src="porto_ecommerce/assets/images/demoes/demo9/products/product-10-2.jpg" alt="product" width="300" height="300">
                        </a>
                        <div class="label-group">
                            <span class="product-label label-hot">HOT</span>
                    ...
                    <div class="product-details">
                        ...
                        <h3 class="product-title"> <a href="demo9-product.html">Women Bag</a> </h3>
                        <div class="ratings-container">
                            <div class="product-ratings">
                                <span class="ratings" style="width:0%"></span>
                                <!-- End .ratings -->
                        ...
                        <div class="owl-carousel owl-theme nav-image-center nav-thin nav-style-1" data-owl-options="{
                            ...
                            <div class="product-default pl-3 pr-3">
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title">
                                        <a href="demo9-product.html">Women Winter Shoes</a>
                                    </h3>
                                    <div class="ratings-container">
                                        <div class="product-ratings">
                                            <span class="ratings" style="width:0%"></span>
                            ...
                            <div class="product-default pl-3 pr-3">
                                <figure>
                                    <a href="demo9-product.html">
                                        <img src="porto_ecommerce/assets/images/demoes/demo9/products/product-7.jpg" alt="product" width="300" height="300" />
                                    </a>
                                    <div class="label-group">
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title">
                                        <a href="demo9-product.html">Women Black Bag</a>
                                    </h3>
                                    <div class="ratings-container">
                                        <div class="product-ratings">
                                            <span class="ratings" style="width:0%"></span>
                    ...
                    <div class="home-products bg-gray p-y-5">
                        ...
                        <div class="owl-carousel owl-theme nav-image-center nav-thin nav-style-1" data-owl-options="{
                            ...
                            <div class="product-default pl-3 pr-3">
                                <figure>
                                    <a href="demo9-product.html">
                                        <img src="porto_ecommerce/assets/images/demoes/demo9/products/product-9.jpg" alt="product" width="300" height="300" />
                                    </a>
                                    <div class="label-group">
                                        <span class="product-label label-sale">-10%</span>
                                    </div>
        ...
        {{-- <div class="brands-section appear-animate p-y-5">
            <div class="container">
                <div class="brands-slider images-center owl-carousel owl-theme nav-pos-outside show-nav-hover appear-animate" data-owl-options="{
                    ...
                    <img src="porto_ecommerce/assets/images/brands/small/brand1.png" width="140" height="60" alt="logo" />
                    <img src="porto_ecommerce/assets/images/brands/small/brand2.png" width="140" height="60" alt="logo" />
                    <img src="porto_ecommerce/assets/images/brands/small/brand3.png" width="140" height="60" alt="logo" />
                    <img src="porto_ecommerce/assets/images/brands/small/brand4.png" width="140" height="60" alt="logo" />
                    <img src="porto_ecommerce/assets/images/brands/small/brand5.png" width="140" height="60" alt="logo" />
                    <img src="porto_ecommerce/assets/images/brands/small/brand6.png" width="140" height="60" alt="logo" />
                </div>
